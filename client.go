...
// APIClient manages communication with the SQLRules API - Evaluation of test coverage for SQL database queries API v3.3.19
...
type APIClient struct {
	...
	SqlrulesApi *SqlrulesApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.SqlrulesApi = (*SqlrulesApiService)(&c.common)
